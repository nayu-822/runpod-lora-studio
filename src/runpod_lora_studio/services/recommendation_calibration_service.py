    ...
    state = _hash(
        {
            ...
            "selected_gpu_status": record.selected_gpu_status,
            "selected_gpu_warning_codes_json": record.selected_gpu_warning_codes_json,
            "memory_failure_codes_json": record.memory_failure_codes_json,
            "exclusion_reasons_json": record.exclusion_reasons_json,
